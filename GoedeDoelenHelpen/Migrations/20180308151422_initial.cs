        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KVKNumber = table.Column<string>(maxLength: 8, nullable: false),
                    FiscalNumber = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CharityApplicationUserRole = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CharityApplicationUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CharityApplicationUsers_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CharityApplicationUsers_Charities_CharityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    EventId = table.Column<int>(nullable: false),
                    EventTeamId = table.Column<int>(nullable: true),
                    TeamParticipantRole = table.Column<int>(nullable: false),
                    Discriminator = table.Column<string>(nullable: false),
                    ApplicationUserId = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeamParticipants_EventTeams_EventTeamId",
                        column: x => x.EventTeamId,
                        principalTable: "EventTeams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TeamParticipants_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventTeamId = table.Column<int>(nullable: true),
                    ProjectId = table.Column<int>(nullable: true),
                    TeamParticipantId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Donations_EventParticipants_EventParticipantId",
                        column: x => x.EventParticipantId,
                        principalTable: "EventParticipants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Donations_EventTeams_EventTeamId",
                        column: x => x.EventTeamId,
                        principalTable: "EventTeams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Donations_TeamParticipants_TeamParticipantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharityApplicationUsers_ApplicationUserId",
                table: "CharityApplicationUsers",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CharityApplicationUsers_CharityId",
                table: "CharityApplicationUsers",
                column: "CharityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Donations_EventParticipantId",
                table: "Donations",
                column: "EventParticipantId");

            migrationBuilder.CreateIndex(
                name: "IX_Donations_EventTeamId",
                table: "Donations",
                column: "EventTeamId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Donations_TeamParticipantId",
                table: "Donations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamParticipants_EventTeamId",
                table: "TeamParticipants",
                column: "EventTeamId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamParticipants_ApplicationUserId",
                table: "TeamParticipants",
                column: "ApplicationUserId");
        }
